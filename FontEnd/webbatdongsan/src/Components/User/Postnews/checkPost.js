...
let checkPost = () => {
    ...
    let img = document.getElementById('upload').files
    ...
    if (unit.value === "Thỏa Thuận" //Điều Kiện
    ...
    if (arr.length === 15 || arr_1.length === 1 || arr_2.length === 1 || arr_3.length === 1  || arr_4.length === 1) {
        console.log(true);
        return true;
    } else {
        console.log(false);
